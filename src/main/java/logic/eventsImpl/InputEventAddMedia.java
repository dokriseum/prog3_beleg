...
public class InputEventAddMedia extends InputEvent {
    ...
    public InputEventAddMedia(Object source, String text, MediaType eventMediaType, int eventSamplingRate, int eventWidth, int eventHeight, String eventEncording, String eventHolder, long eventBitrate, Duration eventLength, Collection<Tag> eventTags, Uploader eventUploader, Date eventUploadDate, String eventType) {
        super(source, text);
