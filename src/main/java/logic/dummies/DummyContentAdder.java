...
public class DummyContentAdder {
    ...
    public DummyContentAdder(BusinessLogic businessLogic) {
    ...
    private void uploadRandomContent() {
        ...
        try {
            ...
            this.outputText = "FULL: " + this.businessLogic.getStorage().getSize() + '/' + this.businessLogic.getStorage().getCapacity();
        }
    }
    ...
    private void fillParametersForContent() {
        ...
        Integer[] randomSamplingrate = {32000, 44100, 48000, 88200, 96000, 192000};
        ...
        if (randomMediaType.equals(MediaType.InteractiveVideo)) {
            ...
            randomEncording = "DWT";
            randomHolder = null;
            randomBitrate = this.random.nextInt(256000);
            ...
            randomSamplingRate = randomSamplingrate[this.random.nextInt(6)];
            randomWidth = this.mapResolution.get("width").get(indexForMapResolution);
            randomHeight = this.mapResolution.get("height").get(indexForMapResolution);
            randomEncording = "DWT";
