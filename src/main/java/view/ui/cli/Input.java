        ...
        switch (inputChoice) {
            case ADD:
                ...
                if (inputStringSplitted.length >= 2) {
                    ...
                    if (tempMediaType == MediaType.LicensedAudioVideo) {
                        return new InputEventAddMedia(this, "InputEventAddMedia",
                                tempMediaType,
            ...
            case SHOW:
                ...
                if (inputStringSplitted[0].equals("content")) {
                    if (inputStringSplitted.length == 2) {
                        return new InputEventShowMedia(this, "InputEventShowMediaByType", MediaType.valueOf(inputStringSplitted[1]));
                    } else if (inputStringSplitted.length == 1) {
                        return new InputEventShowMedia(this, "InputEventShowMedia");
                    } else {
                ...
                if (inputStringSplitted[0].equals("tag")) {
                    if (inputStringSplitted.length == 2) {
                        return new InputEventShowMedia(this, "InputEventShowMediaTags", inputStringSplitted[1].charAt(0));
                    } else if (inputStringSplitted.length == 1) {
                        return new InputEventShowMedia(this, "InputEventShowMediaTags");
                    } else {
                        throw new IllegalArgumentException("illegal media type");
                    }
                }
